  ...
  return (
    <div className="form-page">
      ...
      <form  onSubmit={(e) => uptadeParty(e)}>
        ...
        <label>
          <span>Descrição:</span>
          <input type="text" placeholder="Conte mais sobre a festa..." required onChange={(e) => setParty({...party, description: e.target.value})} value={party.description}/>
        </label>
        <label>
          <span>Orçamento:</span>
          <input type="number" placeholder="Quando você pretende investir?" required onChange={(e) => setParty({...party, budget: e.target.value})} value={party.budget}/>
        </label>
        <label>
          <span>Imagem:</span>
